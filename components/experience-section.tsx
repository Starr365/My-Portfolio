  ...
  return (
    <section id="experience" className="py-16 sm:py-20 lg:py-24 px-3 sm:px-4 bg-background relative overflow-hidden" ref={ref}>
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        >
          <motion.div
            className="inline-flex items-center gap-2 px-4 py-2 mb-6 hover:border-primary/40 transition-colors duration-300"
            whileHover={{ scale: 1.05 }}
          >
            <motion.div
          ...
          <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-foreground mb-4 sm:mb-6 neon-text">
